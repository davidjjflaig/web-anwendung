...
export default function BookDetails() {
  ...
  const handleDelete = async () => {
    if (!buch || !window.confirm(`Möchtest du "${buch.titel.title}" wirklich löschen?`)) return;
      ...
      <div className="card lg:card-side bg-base-100 shadow-xl border border-base-200">
        ...
        <div className="card-body lg:w-2/3">
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              <div className="stat-title">Preis</div>
            ...
            <div>
              ...
              <div className="font-mono font-bold">{buch.isbn}</div>
            </div>
          </div>
